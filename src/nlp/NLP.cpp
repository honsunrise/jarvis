...
NLP::NLP(std::function<void(int reason)> on_result, std::function<void()> on_speech_begin,
...
NLP::NLP(std::function<void(int reason)> on_result, std::function<void(int reason)> on_error)
