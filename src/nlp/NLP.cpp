...
NLP::NLP(std::function<void(const char *result, char is_last)> on_result, std::function<void()> on_speech_begin,
...
NLP::NLP(std::function<void(const char *result, char is_last)> on_result, std::function<void(int reason)> on_error)
